...
#
    ...
    if strawDesign != 4 and strawDesign != 10:
     ...
     c.chambers.Tub1length = 25 / 6 * u.m
...
# size of straws
 ...
 #HPT
    ...
    c.UpstreamTagger.Y_Glass = 63 * u.cm
    ...
    c.UpstreamTagger.Y_PMMA = 64.8 * u.cm
    ...
    c.UpstreamTagger.Y_FreonSF6 = 64.2 * u.cm
    ...
    c.UpstreamTagger.Y_FR4 = 66.6 * u.cm
